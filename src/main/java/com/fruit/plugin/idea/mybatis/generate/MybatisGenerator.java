...
import com.fruit.plugin.idea.mybatis.model.Config;
import com.fruit.plugin.idea.mybatis.model.DbType;
import com.fruit.plugin.idea.mybatis.setting.PersistentConfig;
import com.fruit.plugin.idea.mybatis.util.DbToolsUtils;
import com.fruit.plugin.idea.mybatis.util.GeneratorCallback;
    ...
    private void addPluginConfiguration(Context context) {
        ...
        if (config.isOffsetLimit()) {
            if (DbType.MySQL.equals(dbType)
                ...
                mySQLLimitPlugin.addProperty("type", "com.fruit.plugin.idea.mybatis.generate.plugin.MySQLLimitPlugin");
                mySQLLimitPlugin.setConfigurationType("com.fruit.plugin.idea.mybatis.generate.plugin.MySQLLimitPlugin");
        ...
        if (config.isNeedForUpdate()) {
            if (DbType.MySQL.equals(dbType)
                ...
                mySQLForUpdatePlugin.addProperty("type", "com.fruit.plugin.idea.mybatis.generate.plugin.MySQLForUpdatePlugin");
                mySQLForUpdatePlugin.setConfigurationType("com.fruit.plugin.idea.mybatis.generate.plugin.MySQLForUpdatePlugin");
